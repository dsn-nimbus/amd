...
const CAMINHO_SRC_ARQUIVOS_JS_BOOTSTRAP_3 = `${CAMINHO_BASE_BOOTSTRAP}/3.x/src/js/*.js`;
...
const CAMINHO_SRC_ARQUIVOS_JS_BOOTSTRAP_4 = `${CAMINHO_BASE_BOOTSTRAP}/4.x/src/js/*.js`;
...
module.exports = {
  ...
  v3: {
    ...
    srcArquivosJs: CAMINHO_SRC_ARQUIVOS_JS_BOOTSTRAP_3,
  ...
  v4: {
    ...
    srcArquivosJs: CAMINHO_SRC_ARQUIVOS_JS_BOOTSTRAP_4,
