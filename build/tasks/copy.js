...
gulp.task('copia-css-b4', () => {
  ...
  const DEPENDENCIAS_BS_V4_PASTA_CSS = constantes.bootstrap.v4.documentacaoDepsCSS;
...
gulp.task('copia-js-b4', () => {
  ...
  const DEPENDENCIAS_BS_V4_PASTA_JS = constantes.bootstrap.v4.documentacaoDepsJS;
